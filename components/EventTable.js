        ...
        return(
            <View style={styles.event}>
                    ...
                    <View style={styles.eventResponse}>
                        <Button style={styles.eventLeftButton} title="Going" onPress={() => Alert.alert('Going function here')}/>    
                        <Button style={styles.eventRightButton} title="Not Going" onPress={() => Alert.alert('Not Going function here')}/>    
                    </View>
            </View>
