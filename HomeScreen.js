  ...
  return (
    ...
    <Text style={styles.normText}> Feed will go here </Text>
      ...
      <View style={styles.menu}>
        <MenuItem
          itemImage={require("./icons/eat.png")}
          fnc={() => alert("eat")}
        />
        <MenuItem
          itemImage={require("./icons/gym.png")}
          fnc={() => alert("gym")}
        />
        <MenuItem
          itemImage={require("./icons/alc.png")}
          fnc={() => alert("beer")}
        />
        <MenuItem
          itemImage={require("./icons/study.png")}
          fnc={() => alert("study")}
        />
        <MenuItem
          itemImage={require("./icons/shop.png")}
          fnc={() => alert("shop")}
        />
        <MenuItem
          itemImage={require("./icons/other.png")}
          fnc={() => alert("other")}
        />
      </View>
      {/*
